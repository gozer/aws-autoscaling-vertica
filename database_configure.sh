...
vsql -c "CREATE TABLE autoscale.terminations (queued_by_node varchar(15), removed_by_node varchar(15), start_time timestamp, end_time timestamp, duration_s int, ec2_instanceid varchar(20), node_address varchar(15), node_subnet_cidr varchar(25), node_public_address varchar(15), lifecycle_action_token varchar(128), status varchar(128), is_running boolean) ORDER BY start_time UNSEGMENTED ALL NODES";
